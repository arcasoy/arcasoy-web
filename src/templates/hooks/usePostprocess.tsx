...
const usePostProcess = () => {
  ...
  const [screenCamera, screenScene, screen, renderTarget] = useMemo(() => {
    ...
    const screenShaderMaterial = new THREE.RawShaderMaterial({
      uniforms: {
        diffuse: { value: null },
        time: { value: 0 },
      },
    ...
    screenShaderMaterial.uniforms.diffuse.value = renderTarget.texture
    screen.material = screenShaderMaterial
